...
public class TopPhones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, topphonesadapter.ClickListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_phones);
        setTitle("Top Phones");

        mToolbar = (Toolbar) findViewById(R.id.topphonesapp_bar);
        setSupportActionBar(mToolbar);
        mDrawer = (NavigationView) findViewById(R.id.topphonesmain_drawer);
        mDrawer.setNavigationItemSelectedListener(this);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.topphonesdrawer_layout);
        ...
        spinner1 = (ProgressBar) findViewById(R.id.progressBartopphoneslist1);
        new GetAllPhonesTask().execute(new ApiConnector());
        spinner1.setVisibility(View.VISIBLE);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipetopphoneslist);
        swipeRefreshLayout.setOnRefreshListener(this);
    }

    public List<topphoneslist> getData() {


        List<topphoneslist> data = new ArrayList<>();
        ...
        if (flag == 1) {
            ...
            for (int i = 0; i < count; i++) {
                topphoneslist current = new topphoneslist();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_top_phones, menu);
        return true;
    }
    ...
    public void setTextToTextView(JSONArray jsonArray) {
        ...
        if (flag == 1) {
            ...
            adapter = new topphonesadapter(this, getData());
...
class ApiConnector {
    ...
    public JSONArray GetAllPhones() {
        ...
        String url = "http://mobikit.host22.com/TopPhonesListFetch.php";
