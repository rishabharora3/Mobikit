...
public class BudgetPhones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, budgetphonesadapter.ClickListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {


    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private budgetphonesadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_budget_phones);
        setTitle("Budget Phones");

        mToolbar = (Toolbar) findViewById(R.id.budgetphonesapp_bar);
        setSupportActionBar(mToolbar);
        mDrawer = (NavigationView) findViewById(R.id.budgetphonesmain_drawer);
        mDrawer.setNavigationItemSelectedListener(this);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.budgetphonesdrawer_layout);
        ...
        spinner1 = (ProgressBar) findViewById(R.id.progressBarbudgetphoneslist1);
        new GetAllPhonesTask().execute(new ApiConnector());
        spinner1.setVisibility(View.VISIBLE);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipebudgetphoneslist);
        swipeRefreshLayout.setOnRefreshListener(this);
    }

    public List<budgetphoneslist> getData() {


        List<budgetphoneslist> data = new ArrayList<>();
        ...
        if (flag == 1) {
            ...
            for (int i = 0; i < count; i++) {
                budgetphoneslist current = new budgetphoneslist();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_budget_phones, menu);
        return true;
    }
    ...
    public void setTextToTextView(JSONArray jsonArray) {
        ...
        if (flag == 1) {
            ...
            adapter = new budgetphonesadapter(this, getData());
...
class ApiConnector {
    ...
    public JSONArray GetAllPhones() {
        ...
        String url = "http://mobikit.host22.com/BudgetPhonesListFetch.php";
