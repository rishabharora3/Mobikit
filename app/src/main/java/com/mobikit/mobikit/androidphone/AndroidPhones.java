...
public class AndroidPhones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, androidphonesadapter.ClickListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {


    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private androidphonesadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_android_phones);
        setTitle("Android Phones");

        mToolbar = (Toolbar) findViewById(R.id.androidphonesapp_bar);
        setSupportActionBar(mToolbar);
        mDrawer = (NavigationView) findViewById(R.id.androidphonesmain_drawer);
        mDrawer.setNavigationItemSelectedListener(this);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.androidphonesdrawer_layout);
        ...
        spinner1 = (ProgressBar) findViewById(R.id.progressBarandroidphones);
        new GetAllPhonesTask().execute(new ApiConnector());
        spinner1.setVisibility(View.VISIBLE);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeandroidphoneslist);
        swipeRefreshLayout.setOnRefreshListener(this);
    }

    public List<androidphoneslist> getData() {


        List<androidphoneslist> data = new ArrayList<>();
        ...
        if (flag == 1) {
            ...
            for (int i = 0; i < count; i++) {
                androidphoneslist current = new androidphoneslist();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_android_phones, menu);
        return true;
    }
    ...
    public void setTextToTextView(JSONArray jsonArray) {
        ...
        if (flag == 1) {
            ...
            recyclerView = (RecyclerView) findViewById(R.id.androidphoneslist);
            recyclerView.setHasFixedSize(true);
            adapter = new androidphonesadapter(this, getData());
...
class ApiConnector {
    ...
    public JSONArray GetAllPhones() {
        ...
        String url = "http://mobikit.host22.com/AndroidPhonesListFetch.php";
