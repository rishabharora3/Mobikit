...
public class DualSimPhones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, dualsimphonesadapter.ClickListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {


    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private dualsimphonesadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dual_sim_phones);
        setTitle("Dual Sim Phones");

        mToolbar = (Toolbar) findViewById(R.id.dualsimphonesapp_bar);
        setSupportActionBar(mToolbar);
        mDrawer = (NavigationView) findViewById(R.id.dualsimphonesmain_drawer);
        mDrawer.setNavigationItemSelectedListener(this);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.dualsimphonesdrawer_layout);
        ...
        spinner1 = (ProgressBar) findViewById(R.id.progressBardualsimphoneslist1);
        new GetAllPhonesTask().execute(new ApiConnector());
        spinner1.setVisibility(View.VISIBLE);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipedualsimphoneslist);
        swipeRefreshLayout.setOnRefreshListener(this);
    }

    public List<dualsimphoneslist> getData() {


        List<dualsimphoneslist> data = new ArrayList<>();
        ...
        if (flag == 1) {
            ...
            for (int i = 0; i < count; i++) {
                dualsimphoneslist current = new dualsimphoneslist();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_dual_sim_phones, menu);
        return true;
    }
    ...
    public void setTextToTextView(JSONArray jsonArray) {
        ...
        if (flag == 1) {
            ...
            recyclerView = (RecyclerView) findViewById(R.id.dualsimphoneslist);
            recyclerView.setHasFixedSize(true);
            adapter = new dualsimphonesadapter(this, getData());
...
class ApiConnector {
    ...
    public JSONArray GetAllPhones() {
        ...
        String url = "http://mobikit.host22.com/DualSimPhonesListFetch.php";
