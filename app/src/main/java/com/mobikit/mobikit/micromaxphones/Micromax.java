...
public class Micromax extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, micromaxadapter.ClickListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {


    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private micromaxadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.micromaxapp_bar);
        setSupportActionBar(mToolbar);
        mDrawer = (NavigationView) findViewById(R.id.micromaxmain_drawer);
        mDrawer.setNavigationItemSelectedListener(this);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.micromaxdrawer_layout);
        ...
        spinner1 = (ProgressBar) findViewById(R.id.progressBarmicromaxlist1);
        new GetAllPhonesTask().execute(new ApiConnector());
        spinner1.setVisibility(View.VISIBLE);

        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipemicromaxlist);
        swipeRefreshLayout.setOnRefreshListener(this);
    }

    public List<micromaxlist> getData() {


        List<micromaxlist> data = new ArrayList<>();
        ...
        if (flag == 1) {
            ...
            for (int i = 0; i < count; i++) {
                micromaxlist current = new micromaxlist();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_micromax, menu);
        return true;
    }
    ...
    public void setTextToTextView(JSONArray jsonArray) {
        ...
        if (flag == 1) {
            ...
            recyclerView = (RecyclerView) findViewById(R.id.micromaxlist);
            recyclerView.setHasFixedSize(true);
            adapter = new micromaxadapter(this, getData());
...
class ApiConnector {
    ...
    public JSONArray GetAllPhones() {
        ...
        String url = "http://mobikit.host22.com/MicromaxListFetch.php";
